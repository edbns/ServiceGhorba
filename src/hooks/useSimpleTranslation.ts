...
const translations = {
  en: {
    ...
    'formats.category_service': 'Service & Entry Level',
    'formats.category_regional': 'Regional Formats',
    'formats.category_specialized': 'Specialized',
    ...
    // Upload
    'upload.drop_here': 'Drop your CV here',
    'upload.or_browse': 'or click to browse files',
    'upload.choose_file': 'Choose File',
    'upload.supports': 'Supports PDF and DOCX files up to 10MB',
  ...
  fr: {
    ...
    'formats.category_service': 'Services & Débutants',
    'formats.category_regional': 'Formats régionaux',
    'formats.category_specialized': 'Spécialisés',
    ...
    // Upload
    'upload.drop_here': 'Déposez votre CV ici',
    'upload.or_browse': 'ou cliquez pour parcourir les fichiers',
    'upload.choose_file': 'Choisir un fichier',
    'upload.supports': 'Prend en charge les fichiers PDF et DOCX jusqu\'à 10 Mo',
