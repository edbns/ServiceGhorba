...
const translations = {
  ...
  fr: {
    ...
    'tools.country_subtitle': 'Nous recommanderons le meilleur format de CV pour votre pays cible',
    'tools.job_templates': 'Modèles d\'emploi rapides',
    'tools.job_subtitle': 'Choisissez votre type d\'emploi pour commencer avec des exemples professionnels',
    ...
    'tools.search_country': 'Rechercher votre pays',
  ...
  ar: {
    ...
    // Helper Tools
    'tools.country_selector': 'أين تتقدم للعمل؟',
    'tools.country_subtitle': 'سنوصي بأفضل تنسيق سيرة ذاتية لبلدك المستهدف',
    'tools.job_templates': 'قوالب العمل السريعة',
    'tools.job_subtitle': 'اختر نوع وظيفتك للبدء بأمثلة مهنية',
    'tools.skill_translator': 'مترجم المهارات',
    'tools.skill_subtitle': 'أخبرنا عن عملك وسنحوله إلى مهارات مهنية لسيرتك الذاتية',
    'tools.translate_skills': 'تحويل إلى مهارات مهنية',
    'tools.translating': 'جاري التحويل إلى مهارات مهنية...',
    'tools.your_skills': 'مهاراتك المهنية:',
